...
{
    /// <summary>
    /// Абстрактний продукт — Букет, тепер реалізує Prototype
    /// </summary>
    public abstract class Bouquet : IPrototype
    {
        ...
        public List<string> GetParts() => new List<string>(_parts);

        public abstract Bouquet Clone();
    }

    public class RoseBouquet : Bouquet
    {
        public override Bouquet Clone()
        {
            var clone = (RoseBouquet)MemberwiseClone();
    ...
    public class MixedBouquet : Bouquet
    {
        public override Bouquet Clone()
        {
            var clone = (MixedBouquet)MemberwiseClone();
            clone._parts = new List<string>(_parts);
            return clone;
        }
    }
    ...
    public class WeddingBouquet : Bouquet
    {
        public override Bouquet Clone()
        {
            var clone = (WeddingBouquet)MemberwiseClone();
            clone._parts = new List<string>(_parts);
            return clone;
        }
    }
