namespace BuilderMethodAppWinForms
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            listClones = new ListBox();
            btnClone = new Button();
            btnViewClone = new Button();
            btnModifyClone = new Button();
            ...
            // listClones
            // 
            listClones.FormattingEnabled = true;
            listClones.ItemHeight = 15;
            listClones.Location = new Point(630, 118);
            listClones.Name = "listClones";
            listClones.Size = new Size(152, 199);
            listClones.TabIndex = 5;
            listClones.SelectedIndexChanged += listBox1_SelectedIndexChanged;
            // 
            // btnClone
            // 
            btnClone.Location = new Point(6, 22);
            btnClone.Name = "btnClone";
            btnClone.Size = new Size(152, 23);
            btnClone.TabIndex = 6;
            btnClone.Text = "Клонувати букет";
            btnClone.UseVisualStyleBackColor = true;
            btnClone.Click += btnClone_Click;
            // 
            // btnViewClone
            // 
            btnViewClone.Location = new Point(6, 51);
            btnViewClone.Name = "btnViewClone";
            btnViewClone.Size = new Size(152, 23);
            btnViewClone.TabIndex = 7;
            btnViewClone.Text = "Переглянути клон";
            btnViewClone.UseVisualStyleBackColor = true;
            btnViewClone.Click += btnViewClone_Click;
            // 
            // btnModifyClone
            // 
            btnModifyClone.Location = new Point(6, 80);
            btnModifyClone.Name = "btnModifyClone";
            btnModifyClone.Size = new Size(152, 23);
            btnModifyClone.TabIndex = 8;
            btnModifyClone.Text = "Змінити клон";
            btnModifyClone.UseVisualStyleBackColor = true;
            btnModifyClone.Click += btnModifyClone_Click;
            // 
            // groupBox4
            // 
            groupBox4.Controls.Add(btnClone);
            groupBox4.Controls.Add(btnModifyClone);
            groupBox4.Controls.Add(btnViewClone);
            groupBox4.Location = new Point(615, 325);
            groupBox4.Name = "groupBox4";
            groupBox4.Size = new Size(167, 113);
            groupBox4.TabIndex = 9;
            groupBox4.TabStop = false;
            groupBox4.Text = "Клонування букета";
            // 
            // Form1
            // 
        ...
        private ListBox listClones;
        private Button btnClone;
        private Button btnViewClone;
        private Button btnModifyClone;
